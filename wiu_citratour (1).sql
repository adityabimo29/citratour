...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 02, 2021 at 10:56 AM
...
(1, 2, NULL, 'daily', 'KARIMUN WAGON', NULL, 'karimun-wagon-47.jpeg', NULL),
(2, 2, NULL, 'daily', 'DAIHATSU AYLA', NULL, 'daihatsu-ayla-26.jpeg', NULL),
...
(88, '::1', '2021-03-02', 1255, '1614678918', '00:00:00'),
(89, '127.0.0.1', '2021-03-02', 4, '1614671611', '00:00:00');
...
INSERT INTO `tour_kategori` (`id_tour_kategori`, `judul`, `judul_seo`, `deskripsi`, `pien`) VALUES
(3, 'Wisata 1 Hari', 'wisata-1-hari', NULL, 'tour-jogja'),
(4, 'Wisata 2 Hari 1 Malam', 'wisata-2-hari-1-malam', NULL, 'tour-jogja'),
(5, 'Wisata 5 Hari 4 Malam', 'wisata-5-hari-4-malam', NULL, 'tour-jogja'),
(6, 'Wisata 3 Hari 2 Malam', 'wisata-3-hari-2-malam', NULL, 'tour-jogja'),
(7, 'Wisata 4 Hari 3 Malam', 'wisata-4-hari-3-malam', NULL, 'tour-jogja'),
(8, 'SOLO', 'solo', NULL, 'tour-lain'),
(9, 'BROMO', 'bromo', NULL, 'tour-lain'),
(10, 'SEMARANG', 'semarang', NULL, 'tour-lain'),
(11, 'BANDUNG', 'bandung', NULL, 'tour-lain'),
(12, 'MALANG', 'malang', NULL, 'tour-lain'),
(13, 'DIENG', 'dieng', NULL, 'tour-lain'),
(14, 'BALI', 'bali', NULL, 'tour-lain'),
(15, 'LOMBOK', 'lombok', NULL, 'tour-lain');
...
--
ALTER TABLE `daily_car`
  MODIFY `id_daily_car` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `daily_description`
--
ALTER TABLE `daily_description`
  MODIFY `id_daily_description` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `tour`
  MODIFY `id_tour` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `tour_kategori`
--
ALTER TABLE `tour_kategori`
  MODIFY `id_tour_kategori` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
