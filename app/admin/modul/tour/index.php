                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <ul class="nav nav-tabs" role="tablist">
                                    <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#harga"
                                            role="tab"><span class="hidden-sm-up"><i class="sl-icon-umbrella"></i></span>
                                            <span class="hidden-xs-down">Harga</span></a> </li>
                                    <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#fasilitas"
                                            role="tab"><span class="hidden-sm-up"><i class="sl-icon-support"></i></span>
                                            <span class="hidden-xs-down">Fasilitas</span></a> </li>
                                </ul>
                                <!-- Tab panes -->
                                <div class="tab-content tabcontent-border">
                                    <div class="tab-pane active" id="harga" role="tabpanel">
                                        <div class="p-20">
                                            <textarea  id="ckeditor2" name="harga"  rows="4"></textarea>
                                        </div>
                                    </div>
                                    <div class="tab-pane  p-20" id="fasilitas" role="tabpanel">
                                        <textarea  id="ckeditor3" name="fasilitas" rows="4"></textarea>
                                    </div>
                                </div>
                            </div>
                            <!-- <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <img style="height: 150px;"
                                        src="../images/tour/small/<?php echo $data['gambar'] ?>" alt="">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="tab-content tabcontent-border">
                                    <div class="tab-pane active" id="harga" role="tabpanel">
                                        <div class="p-20">
                                            <textarea  id="ckeditor2" name="harga"  rows="4"><?php echo $data['harga'] ?></textarea>
                                        </div>
                                    </div>
                                    <div class="tab-pane  p-20" id="fasilitas" role="tabpanel">
                                        <textarea  id="ckeditor3" name="fasilitas" rows="4"><?php echo $data['fasilitas'] ?></textarea>
                                    </div>
                                </div>
                            </div>
