<?php $this->layout('template', ['hal'=>'Daily Rent Service Kategori']) ?>
<?php
	$module = 'tempat-wisata';
	switch($act){
		case "list":
	?>      
						...
						?>
							<tr>
								...
								<td align="center" style="width:20%">
									<button type="button" class="btn btn-warning" data-toggle="modal" data-target="#<?php echo $r['id_tempat_wisata'] ?>" > <i class="fas fa-pencil-alt"></i> Edit</button>
									<a onClick="javascript: return confirm('Yakin untuk Menghapus data ?');" href="<?php echo $module; ?>-delete-<?php echo $r['id_tempat_wisata']; ?>"  class="btn btn-danger btnadmin" role="button" aria-pressed="true" style="min-width: 60px;"> <i class="fa fa-trash"></i> Delete</a>
								</td>
							</tr>
						<!-- modal edit content -->
						<div id="<?php echo $r['id_tempat_wisata'] ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
							<div class="modal-dialog modal-lg">
								<div class="modal-content">
									...
									<div class="modal-body">
										<form action="tempat-wisata" method="POST" enctype="multipart/form-data">
										<input type="hidden" name="id_tempat_wisata" value="<?php echo $r['id_tempat_wisata']; ?>">
	...
	<?php
		break;
		case "edit":
		$edit = $db->connection("SELECT * FROM portofolio_kategori WHERE id_tempat_wisata='$_GET[id]'");
				...
				<div class="col-md-12 card">
				  ...
				  <div class="ccard-body">
					...
					<form role="form" action="modul/portofolio_kategori/aksi.php?module=<?php echo $module; ?>&act=update" method="POST" enctype="multipart/form-data" >
						<input type="hidden" name="id_tempat_wisata" value="<?php echo $tedit['id_tempat_wisata']; ?>">
