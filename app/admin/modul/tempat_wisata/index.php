<?php $this->layout('template', ['hal'=>'Tempat Wisata']) ?>
<?php
                    ...
                    <table id="my_table" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th width="23%" class="center">Lokasi</th>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="tempat-wisata" method="POST" enctype="multipart/form-data">
                                                <input type="hidden" name="id_tempat_wisata"
                                                    value="<?php echo $r['id_tempat_wisata']; ?>">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="id_lokasi" class="form-control">
                                                        ...
                                                        <option value="<?=$l['id_lokasi']?>"
                                                            <?=($l['id_lokasi'] == $r['id_lokasi'])? 'selected' : '' ?>>
                                                            <?=$l['judul']?></option>
                                                        <?php endforeach ?>
                                                    </select>
                                                </div>
            ...
            <div class="modal-body">
                <form action="tempat-wisata" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select name="id_lokasi" class="form-control">
                            <?php foreach($lokasi as $l): ?>
                            <option value="<?=$l['id_lokasi']?>"><?=$l['judul']?></option>
                            <?php endforeach ?>
                        </select>
                    </div>
            </div>
