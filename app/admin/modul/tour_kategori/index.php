                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="<?=$zelda?>" method="POST" enctype="multipart/form-data">
                                                <input type="hidden" name="id_tour_kategori"
                                                    value="<?php echo $r['id_tour_kategori']; ?>">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <br />
                                                    <input type="file" name="lopoFile" id="lopoFile"
                                                        class="form-control ">
                                                    <p style="margin-top: 5px;margin-bottom:0;" class="help-block">*)
                                                        Ukuran Gambar
                                                        Minimal Lebar 1366px dan Tinggi 500px</p>
                                                    <p class="help-block">*) Maksimal Size Gambar 2MB</p>
                                                    <img style="height: 125px;"
                                                        src="../images/tour_kategori/small/<?php echo $r['gambar'] ?>" alt="">
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
...
<section class="content">
    <div class="row">
        ...
        <div class="col-md-12 card">
            ...
            <div class="card-body">
                <!-- form start -->
                <form role="form" action="modul/tour_kategori/aksi.php?module=<?php echo $module; ?>&act=add"
                    method="POST" enctype="multipart/form-data">
                    <div class="box-body table-responsive">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="exampleInputEmail1">judul tour_kategori <span title="wajib"
                                        style="color: red;">*</span></label>
                                <input name="tour_kategori" type="hidden" class="form-control"
    ...
    <div class="row">
        ...
        <div class="col-md-12 card">
            ...
            <div class="ccard-body">
                <!-- form start -->
                <form role="form" action="modul/tour_kategori/aksi.php?module=<?php echo $module; ?>&act=update"
                    method="POST" enctype="multipart/form-data">
...
<section class="content">
    <div class="row">
        <!-- left column -->
        <form role="form" action="modul/tour_kategori/aksi.php?module=<?php echo $module; ?>&act=addgallery"
            method="POST" enctype="multipart/form-data">
