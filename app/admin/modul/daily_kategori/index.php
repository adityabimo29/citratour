...
<?php
	$module = 'daily-kategori';
	switch($act){
		case "list":
	?>      
        <a href="daily-car" class="btn btn-success" > <i class="fas fa-car"></i> Mobil</a>
							...
							<div class="modal-dialog modal-lg">
								<div class="modal-content">
									...
									<div class="modal-body">
										<form action="daily-kategori" method="POST" enctype="multipart/form-data">
